...
public class RandomUtils {
	...
	public static final String RANDOM_SEED_REMOVE_CONFUSING_STRING = "02356789ABCDEFGHJKMNOPQRSTUVWXYZabcdefghjkmnopqrstuvwxyz";// 初始化种子
	...
	public static String random(int bit, String seed) {
		if (bit <= 0)
			bit = 10;
		return RandomStringUtils.random(bit, seed);
	}
